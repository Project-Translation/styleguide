...
https://project-translation.github.io/styleguide/i18n/zh-cn/go
...
文档            | 链接                                                  | 主要受众    | [规范性] | [权威性]
------------------- | ----------------------------------------------------- | ------------------- | ----------- | -----------
**风格指南**     | https://project-translation.github.io/styleguide/i18n/zh-cn/go/guide          | 所有人            | 是         | 是
**风格决策** | https://project-translation.github.io/styleguide/i18n/zh-cn/go/decisions      | 可读性导师 | 是         | 否
**最佳实践**  | https://project-translation.github.io/styleguide/i18n/zh-cn/go/best-practices | 任何感兴趣的人   | 否          | 否
...
1.  **[风格指南](https://project-translation.github.io/styleguide/i18n/zh-cn/go/guide)** 概述了 Google 中 Go 风格的基础。 本文档是权威性的，是风格决策和最佳实践中建议的基础。

1.  **[风格决策](https://project-translation.github.io/styleguide/i18n/zh-cn/go/decisions)** 是一份更详细的文档，总结了关于特定风格点的决策，并在适当的情况下讨论了决策背后的原因。

    这些决策可能会根据新数据、新语言特性、新库或新兴模式而偶尔发生变化，但不期望 Google 的单个 Go 程序员能够及时了解本文档。

1.  **[最佳实践](https://project-translation.github.io/styleguide/i18n/zh-cn/go/best-practices)** 记录了一些随着时间推移而演变的模式，这些模式可以解决常见问题，易于阅读，并且能够满足代码维护的需要。
...
*   **权威性**：建立规定性和持久性规则
    ...
    https://project-translation.github.io/styleguide/i18n/zh-cn/go#canonical
...
*   **规范性**：旨在建立一致性 <a id="normative"></a>
    ...
    https://project-translation.github.io/styleguide/i18n/zh-cn/go#normative
...
*   **符合语言习惯**：常见且熟悉 <a id="idiomatic"></a>
    ...
    https://project-translation.github.io/styleguide/i18n/zh-cn/go#idiomatic
